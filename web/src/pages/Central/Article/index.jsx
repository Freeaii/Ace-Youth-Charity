...
class Article extends Component {
    ...
    componentDidMount() {
        axios.get('/api/information/content',{params:{article_id:this.props.article_id}}).then(
            res=>{
                this.setState({
    ...
    render() {
        const {title,content,date,style,contactEmail,head_portrait,username}=this.state
        return (
            <div className="article_show_page">
                <div className="comeback">
                    <span><Link to="/home" style={{color:"black"}}>首页</Link></span>
                    ...
                    <span>
                        {
                            window.location.pathname.includes('/project/content')?<Link to="/project/show" style={{color:"black"}}>公益项目</Link>:<Link to="/information/show" style={{color:"black"}}>公益资讯</Link>
                        }
                    </span>
                    <svg  viewBox="0 0 1024 1024" version="1.1"
                          xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="article_content">
                    ...
                    <div className="share">
                        <ul>
                            ...
                            <li>
                                <svg className="icon" viewBox="0 0 1138 1024" version="1.1"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <li>
                                <svg className="icon" viewBox="0 0 1024 1024" version="1.1"
                                    ...
                                    <path
                                        ...
                                        />
                                    <path d="M676.16 353.28l51.232 61.44-343.552 286.304-51.2-61.44z"
                                          />
                                </svg>
                            </li>
                            <li>
